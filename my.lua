...
local Button = Tab:Button({
    ...
    Desc = "te ajuda no steal a faz crianÃ§as chorar recomendo demais!",
...
local Dropdown = Tab:Dropdown({
    ...
    Options = {}, -- Inicialmente vazio, serÃ¡ preenchido com os jogadores
...
-- Adicionando o botÃ£o de teleporte

local TeleportButton = Tab:Button({

    Title = "Teleportar",

    Desc = "se vocÃª usar uma alt para ficar na frente da sua base e auto areal!!",
    ...
    Callback = function()
        ...
        if not character or not character:FindFirstChild("HumanoidRootPart") then
            ...
            print("Erro: Personagem do jogador local nÃ£o encontrado!")
        ...
        if not targetPlayer or not targetPlayer.Character or not targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            print("Erro: Jogador selecionado nÃ£o encontrado ou sem personagem!")
        ...
        localRootPart.CFrame = targetRootPart.CFrame * CFrame.new(0, 0, -2) -- Teleporta para trÃ¡s do jogador alvo
...
local function addESP(player)
    ...
    if player ~= localPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
        ...
        highlight.FillTransparency = 0.7 -- TransparÃªncia do preenchimento
...
-- FunÃ§Ã£o para ativar/desativar ESP para todos os jogadores
...
-- Atualizar ESP quando o personagem de um jogador Ã© recarregado
